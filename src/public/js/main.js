...
function ecAccessCookie(e) {
  for (
    var t = e + "=", o = document.cookie.split(";"), s = 0;
    s < o.length;
    s++
  ) {
    var i = o[s].trim();
...
!(function (e) {
  ...
  new (function ({ offset: e } = { offset: 10 }) {
    ...
    function l(e) {
      for (var t = e, o = 0, s = t.length; o < s; o++)
        t[o].dataset.animated || (c(t[o]) && a(t[o]));
    }
    function r() {
      l(
  ...
  e(window).on("scroll", function () {
    ...
    e(".search-btn").on("click", function () {
      e(this).toggleClass("active"),
        e(".dropdown_search").slideToggle("medium");
    }),
    e(function () {
    ...
    e(".sidebar-toggle-icon").on("click", function () {
      e(".filter-sidebar-overlay").fadeIn(),
        e(".filter-sidebar").addClass("toggle-sidebar-swipe");
    }),
    e(".filter-cls-btn").on("click", function () {
      e(".filter-sidebar").removeClass("toggle-sidebar-swipe"),
        e(".filter-sidebar-overlay").fadeOut();
    }),
    ...
    e(".ec-remove-wish").on("click", function () {
      e(this).parents(".pro-gl-content").remove(),
        0 == e(".pro-gl-content").length &&
          e(".ec-wish-rightside, .wish-empt").html(
    ...
    o.on("click", function (t) {
      ...
      e(".ec-side-cart-overlay").fadeIn(),
        ...
        o.parent().hasClass("mobile-menu-toggle") &&
          (o.addClass("close"), e(".ec-side-cart-overlay").fadeOut());
    }),
    ...
    (n = e(".ec-menu-content, .overlay-menu"))
      .find(".sub-menu")
      .parent()
  ...
  e.scrollUp({
    ...
    e(".ec-change-color").on("click", "li", function () {
      e('link[href^="assets/css/skin-"]').remove(),
        e("link.dark").remove(),
          ...
          o &&
            (function (e) {
              ...
              if (o.length) {
                ...
                a.attr("src", s),
                  c.hasClass("disable") && c.removeClass("disable");
              }
  ...
  e(window).on("load", function () {
    ...
    e(document).ready(function () {
      e("footer .footer-top .ec-footer-widget .ec-footer-links").addClass(
        ...
        e(".ec-footer-heading .ec-heading-res").click(function () {
          ...
          t.slideToggle("slow"),
            e(".ec-footer-dropdown").not(t).slideUp("slow");
        });
    }),
    ...
    e(document).on("click", ".btn-grid", function (t) {
      var o = e(".shop-pro-inner"),
        s = e(".pro-gl-content");
      t.preventDefault(),
        o.removeClass("list-view"),
        s.removeClass("width-100");
    }),
    ...
    e(document).on("click", ".btn-grid-50", function (t) {
      var o = e(".shop-pro-inner"),
        s = e(".pro-gl-content");
      t.preventDefault(),
        o.removeClass("list-view-50"),
        s.removeClass("width-50");
    }),
    ...
    e(document).ready(function () {
      e(
        ...
        e(".ec-sidebar-title .ec-sidebar-res").click(function () {
          ...
          t.slideToggle("slow"),
            e(".ec-sidebar-dropdown").not(t).slideUp("slow");
        });
    }),
    e(document).ready(function () {
    ...
    e(document).ready(function () {
      e(".ec-faq-wrapper .ec-faq-block .ec-faq-content").addClass(
        "ec-faq-dropdown",
      ),
    ...
    e(document).ready(function () {
      e(
        ...
        e(".product_page .ec-sidebar-block .ec-sidebar-block-item").click(
          function () {
            var t = e(this)
              .closest(".ec-sb-block-content")
              .find(".ec-cat-sub-dropdown");
            t.slideToggle("slow"),
              e(".ec-cat-sub-dropdown").not(t).slideUp("slow");
          },
        );
    }),
    e(document).ready(function () {
  ...
  e(".cart-qty-plus-minus").append(
    ...
    e(".cart-qty-plus-minus .ec_cart_qtybtn .ec_qtybtn").on(
      "click",
      function () {
        var t = e(this),
    ...
    e(document).ready(function () {
      e(".ec-list").on("click", function () {
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          ...
          : window.open(
              "https://web.WhatsApp.com/send?phone=" + t + "&text=" + o,
              "-blank",
            );
      }),
    ...
    (e.fn.launchBtn = function (t) {
      ...
      (o = e(".ec-button")),
        ...
        e(document).click(function () {
          c(),
            1 === i &&
              o.removeClass("rotateForward").toggleClass("rotateBackward"),
            (i = 0);
        });
    }),
